namespace Demo.Types.FunctionalExtensions
{
    ...
    public static class Extensions
    {
        ...
        public static IResult<NonEmptyString> IfAtLeastOneFailCombineElseReturnOk(this IResult<NonEmptyString>[] results)
        {
            ...
            return failedResults.Any() ? ((NonEmptyString)string.Join("; ", failedResults.Select(result => result.Error.Value).ToImmutableArray())).GetFailResult() : GetOkMessage();
        }
        ...
        public static TReturnedResult GetValue<TReturnedResult>(Func<IResult<TReturnedResult, NonEmptyString>> resultFunc)
        {
        ...
        public static void VoidTee<T>(this T @this, Action<T> action)
        {
            action(@this);
        }
    }
