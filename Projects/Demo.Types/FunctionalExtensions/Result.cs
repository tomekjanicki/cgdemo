namespace Demo.Types.FunctionalExtensions
{
        ...
        where TError : class
    {
        ...
        public static IResult<TError> Ok()
        {
            return new Result<TError>(null);
        }

        public static IResult<TError> Fail(TError error)
        {
        ...
        where TError : class
    {
        ...
        public static IResult<TResult, TError> Ok(TResult value)
        {
            return new Result<TResult, TError>(value, null);
        }

        public static IResult<TResult, TError> Fail(TError error)
        {
